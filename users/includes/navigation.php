...
<div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
	<div class="container">
		...
		<div class="navbar-header ">
			...
			<a class="" href="<?=$us_url_root?>" style="color:#fff;position:reletive; top:10px;">Tracks and Records</a>
		</div>
		<div class="collapse navbar-collapse navbar-top-menu-collapse navbar-right">
			<ul class="nav navbar-nav ">
				<?php if($user->isLoggedIn()){ //anyone is logged in?>
		<li><a href="<?=$us_url_root?>leaderboard.php"><i class="fa fa-fw fa-home"></i> LeaderBoard</a></li> <!-- regular user menu link -->
		<li><a href="<?=$us_url_root?>users/cart.php"><i class="fa fa-fw fa-home"></i> Cart</a></li> <!-- regular user menu link -->
		<li><a href="<?=$us_url_root?>users/show-cart.php"><i class="fa fa-fw fa-home"></i> ShowCart</a></li> <!-- regular user menu link -->
